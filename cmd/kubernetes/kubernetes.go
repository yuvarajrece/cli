...
func init() {
	...
	_ = kubernetesConfigCmd.Flags().MarkDeprecated("switch", "this flag is deprecated, KUBECONFIG is automatically switched to the newly created cluster config if the --save flag is set")
	_ = kubernetesConfigCmd.Flags().MarkHidden("switch")
	...
	_ = kubernetesCreateCmd.Flags().MarkDeprecated("merge", "this flag is deprecated, KUBECONFIG is automatically merged with the newly created cluster config if the --save flag is set")
	_ = kubernetesCreateCmd.Flags().MarkHidden("merge")
	...
	_ = kubernetesNodePoolCreateCmd.Flags().MarkHidden("public-ip")
	...
	_ = kubernetesNodePoolScaleCmd.MarkFlagRequired("nodes")
	...
	_ = kubernetesNodePoolInstanceDeleteCmd.MarkFlagRequired("node-pool-id")
	kubernetesNodePoolInstanceDeleteCmd.Flags().StringVarP(&instanceID, "instance-id", "i", "", "the ID of the instance.")
	_ = kubernetesNodePoolInstanceDeleteCmd.MarkFlagRequired("instance-id")
	...
	_ = kubernetesUpdateCmd.MarkFlagRequired("firewall") // At present, only the firewall can be updated, this can be changed to not required if more options are added in the future.
}
